...
# ACDS 13.0sp1 232 win32 2023.03.09.23:04:58
...
TOP_LEVEL_NAME="qsys_teste"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="D:/documentos/cefet/22.1/tcc/quartus/install2/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog "$QSYS_SIMDIR/submodules/qsys_teste_new_sdram_controller_0.v"                -work new_sdram_controller_0 -cdslib ./cds_libs/new_sdram_controller_0.cds.lib
  ncvlog "$QSYS_SIMDIR/submodules/qsys_teste_new_sdram_controller_0_test_component.v" -work new_sdram_controller_0 -cdslib ./cds_libs/new_sdram_controller_0.cds.lib
  ncvlog "$QSYS_SIMDIR/qsys_teste.v"                                                                                                                                
fi
